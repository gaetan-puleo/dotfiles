...
case $1 in
  all)
    ...
    stow --verbose --target=$HOME --restow act gsimplecal picom autorandr i3 polybar themes icons tmux dunst kitty rofi fish neofetch fonts nix sxhkd git nvim bash
    ;;

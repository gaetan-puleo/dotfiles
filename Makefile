...
.PHONY: help dotfiles dotfiles-linux dotfiles-mac dotfiles-macos setup-ubuntu setup-fedora install vscode-extensions-linux vscode-extensions-mac fisher-plugins fonts-linux
